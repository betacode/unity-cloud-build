...
class BuildtargetsApi(object):
    ...
    def add_build_target(self, body, orgid, projectid, **kwargs):  # noqa: E501
        """Create build target for a project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_build_target(body, orgid, projectid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProjectidBuildtargetsBody body: Options for build target create/update (required)
        ...
        if kwargs.get('async_req'):
            return self.add_build_target_with_http_info(body, orgid, projectid, **kwargs)  # noqa: E501
        else:
            (data) = self.add_build_target_with_http_info(body, orgid, projectid, **kwargs)  # noqa: E501
            return data

    def add_build_target_with_http_info(self, body, orgid, projectid, **kwargs):  # noqa: E501
        """Create build target for a project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_build_target_with_http_info(body, orgid, projectid, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_build_target`")  # noqa: E501
    ...
    def set_env_variables_for_build_target(self, body, orgid, projectid, buildtargetid, **kwargs):  # noqa: E501
        """Set environment variables  # noqa: E501

        Set all configured environment variables for a given build target  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_env_variables_for_build_target(body, orgid, projectid, buildtargetid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param dict(str, str) body: Environment variables (required)
        :param str orgid: Organization identifier (required)
        :param str projectid: Project identifier (required)
        :param str buildtargetid: unique id auto-generated from the build target name (required)
        :return: dict(str, str)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_env_variables_for_build_target_with_http_info(body, orgid, projectid, buildtargetid, **kwargs)  # noqa: E501
        else:
            (data) = self.set_env_variables_for_build_target_with_http_info(body, orgid, projectid, buildtargetid, **kwargs)  # noqa: E501
            return data

    def set_env_variables_for_build_target_with_http_info(self, body, orgid, projectid, buildtargetid, **kwargs):  # noqa: E501
        """Set environment variables  # noqa: E501

        Set all configured environment variables for a given build target  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_env_variables_for_build_target_with_http_info(body, orgid, projectid, buildtargetid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'orgid', 'projectid', 'buildtargetid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `set_env_variables_for_build_target`")  # noqa: E501
        # verify the required parameter 'orgid' is set
        if ('orgid' not in params or
                params['orgid'] is None):
    ...
    def update_build_target(self, body, orgid, projectid, buildtargetid, **kwargs):  # noqa: E501
        """Update build target details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_build_target(body, orgid, projectid, buildtargetid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BuildtargetsBuildtargetidBody body: Options for build target create/update (required)
        :param str orgid: Organization identifier (required)
        :param str projectid: Project identifier (required)
        :param str buildtargetid: unique id auto-generated from the build target name (required)
        :return: object
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_build_target_with_http_info(body, orgid, projectid, buildtargetid, **kwargs)  # noqa: E501
        else:
            (data) = self.update_build_target_with_http_info(body, orgid, projectid, buildtargetid, **kwargs)  # noqa: E501
            return data

    def update_build_target_with_http_info(self, body, orgid, projectid, buildtargetid, **kwargs):  # noqa: E501
        """Update build target details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_build_target_with_http_info(body, orgid, projectid, buildtargetid, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_build_target`")  # noqa: E501
        # verify the required parameter 'orgid' is set
        if ('orgid' not in params or
                params['orgid'] is None):
