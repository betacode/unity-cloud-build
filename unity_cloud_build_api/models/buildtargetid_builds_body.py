...
class BuildtargetidBuildsBody(object):
    ...
    def __init__(self, clean=None, delay=None, commit=None, headless=None, label=None, platform=None):  # noqa: E501
        """BuildtargetidBuildsBody - a model defined in Swagger"""  # noqa: E501
        self._clean = None
        self._delay = None
        self._commit = None
        self._headless = None
    ...
    @property
    def clean(self):
        """Gets the clean of this BuildtargetidBuildsBody.  # noqa: E501


        :return: The clean of this BuildtargetidBuildsBody.  # noqa: E501
        :rtype: bool
        """
        return self._clean
    ...
    def clean(self, clean):
        """Sets the clean of this BuildtargetidBuildsBody.


        :param clean: The clean of this BuildtargetidBuildsBody.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def delay(self):
        """Gets the delay of this BuildtargetidBuildsBody.  # noqa: E501

        Delay to start build, in milliseconds  # noqa: E501

        :return: The delay of this BuildtargetidBuildsBody.  # noqa: E501
        :rtype: float
        """
        return self._delay
    ...
    def delay(self, delay):
        """Sets the delay of this BuildtargetidBuildsBody.

        Delay to start build, in milliseconds  # noqa: E501

        :param delay: The delay of this BuildtargetidBuildsBody.  # noqa: E501
        :type: float
        """
    ...
    @property
    def commit(self):
        """Gets the commit of this BuildtargetidBuildsBody.  # noqa: E501


        :return: The commit of this BuildtargetidBuildsBody.  # noqa: E501
        :rtype: str
        """
        return self._commit
    ...
    def commit(self, commit):
        """Sets the commit of this BuildtargetidBuildsBody.


        :param commit: The commit of this BuildtargetidBuildsBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def headless(self):
        """Gets the headless of this BuildtargetidBuildsBody.  # noqa: E501

        Only valid for local builds   # noqa: E501

        :return: The headless of this BuildtargetidBuildsBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def headless(self, headless):
        """Sets the headless of this BuildtargetidBuildsBody.

        Only valid for local builds   # noqa: E501

        :param headless: The headless of this BuildtargetidBuildsBody.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def label(self):
        """Gets the label of this BuildtargetidBuildsBody.  # noqa: E501

        Only valid for local builds   # noqa: E501

        :return: The label of this BuildtargetidBuildsBody.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this BuildtargetidBuildsBody.

        Only valid for local builds   # noqa: E501

        :param label: The label of this BuildtargetidBuildsBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def platform(self):
        """Gets the platform of this BuildtargetidBuildsBody.  # noqa: E501

        Only valid for local builds   # noqa: E501

        :return: The platform of this BuildtargetidBuildsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def platform(self, platform):
        """Sets the platform of this BuildtargetidBuildsBody.

        Only valid for local builds   # noqa: E501

        :param platform: The platform of this BuildtargetidBuildsBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BuildtargetidBuildsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BuildtargetidBuildsBody):
            return False
