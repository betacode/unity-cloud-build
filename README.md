...
```
swagger-codegen generate -l python -i api.json -c config.json
```
...
## Documentation For Models
 ...
 - [AndroidCredentialidBody](docs/AndroidCredentialidBody.md)
 - [AndroidCredentialidBody1](docs/AndroidCredentialidBody1.md)
 - [ArtifactsDeleteBody](docs/ArtifactsDeleteBody.md)
 - [BuildsNumberBody](docs/BuildsNumberBody.md)
 - [BuildtargetidBuildsBody](docs/BuildtargetidBuildsBody.md)
 - [BuildtargetsBuildtargetidBody](docs/BuildtargetsBuildtargetidBody.md)
 ...
 - [IosCredentialidBody](docs/IosCredentialidBody.md)
 - [IosCredentialidBody1](docs/IosCredentialidBody1.md)
 - [MeDevicesBody](docs/MeDevicesBody.md)
 - [NumberShareBody](docs/NumberShareBody.md)
 - [NumberShareBody1](docs/NumberShareBody1.md)
 - [OrgidHooksBody](docs/OrgidHooksBody.md)
 - [OrgidProjectsBody](docs/OrgidProjectsBody.md)
 ...
 - [OsxCredentialidBody](docs/OsxCredentialidBody.md)
 - [OsxCredentialidBody1](docs/OsxCredentialidBody1.md)
 - [ProjectidBuildtargetsBody](docs/ProjectidBuildtargetsBody.md)
 - [ProjectidHooksBody](docs/ProjectidHooksBody.md)
 - [ProjectsProjectidBody](docs/ProjectsProjectidBody.md)
 - [SigningAndroidBody](docs/SigningAndroidBody.md)
 - [SigningAndroidBody1](docs/SigningAndroidBody1.md)
 - [SigningIosBody](docs/SigningIosBody.md)
 - [SigningIosBody1](docs/SigningIosBody1.md)
 - [SigningOsxBody](docs/SigningOsxBody.md)
 - [SigningOsxBody1](docs/SigningOsxBody1.md)
